...
INSERT INTO director(director_id, first, last) VALUES 
 (1, 'Steven', 'Spielberg'),
 (2, 'J.J.' , 'Abrams'),
 (3, 'Kenneth', 'Branagh'),
 (4, 'Chris', 'Columbus'),
...
INSERT INTO movies(movies_id, name, release_date, director_id) VALUES
...
INSERT INTO actors(actors_id, first, last) VALUES
 (1, 'Harrison', 'Ford'),
 (2, 'Robert', 'Downey Jr.'),
 (3, 'Samuel l.', 'Jackson'),
 (4, 'Daniel', 'Radcliffe'),
...
INSERT INTO middle(middle_id, movies_id, actors_id) VALUES
 (1, 1, 1),
 (2, 2, 1),
 (3, 7, 2),
 (4, 3, 3),
